...
# docker build --no-cache -t us-central1-docker.pkg.dev/mchirico/public/septa:v0.0.1 -f Dockerfile .
# docker push us-central1-docker.pkg.dev/mchirico/public/septa:v0.0.1
